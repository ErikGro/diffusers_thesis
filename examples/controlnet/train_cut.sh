...
RUN_TITLE="25_01_06 MSE and CUT on predicted latents"
RUN_DESCRIPTION="MSE is computed between added noise to latents and predicted noise. CUT loss is computed between predicted latents (noisy_latents - predicted_noise) and groundtruth HE latents."
...
nohup accelerate launch --gpu_ids $CUDA_VISIBLE_DEVICES train_controlnet_cut.py \
